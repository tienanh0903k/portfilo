    ...
    <div className="flex min-h-screen bg-[#0a101f] justify-center hide-scrollbar">
      <div className="flex w-4/5">
        ...
        <div className="flex flex-1">
          ...
          <div className="w-full m-4 md:w-80 bg-[#1e3a8a] p-6 flex flex-col items-center rounded-lg">            
            ...
            <h1 className="text-2xl font-bold text-white">Nguyen Tien Anh</h1>
            <p className="text-blue-300 mb-2">Full-Stack Web Developer</p>

            <div className="flex items-center text-gray-300 mb-6">
              <MapPin className="w-4 h-4 mr-1" />
              <span className="text-sm">Hung Yen</span>
            </div>

            <div className="flex gap-3 mb-6">
              <a
                href="#"
                className="w-8 h-8 rounded-full bg-[#1a2234] flex items-center justify-center text-gray-300 hover:bg-blue-600 hover:text-white transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
            ...
            <div className="flex gap-3 w-full">
              ...
              <Button
                variant="outline"
                className="flex-1 border-blue-600 text-blue-400 hover:bg-blue-800 hover:text-white"
              >
